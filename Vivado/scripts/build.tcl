...
dict set target_dict vhk158 { xilinx.com vhk158 versal { 0 1 2 3 } "10" }
...
dict set target_dict vhk158_25g { xilinx.com vhk158 versal { 0 1 2 3 } "25" }
...
dict set target_dict vpk180_25g { xilinx.com vpk180 versal { 0 1 2 3 } "25" }
